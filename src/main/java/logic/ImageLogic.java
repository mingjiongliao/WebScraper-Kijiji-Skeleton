...
+ImageLogic()
+getAll() : List<Image>
+getWithId(id : int) : Image
+getWithUrl(url : String) : List<Image>
+getWithPath(path : String) : Image
+getWithName(name : String) : List<Image>
+search(search : String) : List<Image>
+createEntity(parameterMap : Map<String, String[]>) : Image
